...
Needs **JDK 25 or 26**. `JAVA_HOME` must point at one, or surefire forks the wrong JVM and the run
dies on a "class file version" error. On Windows use `mvnw.cmd` and
...
<project_guardrails>
  <ignored_elements>
    <file path="se.deversity.blindbean.processor.HomomorphicProcessor.getBoxedType(java.lang.String)">
      <reason>Pure internal type-mapping helper — not part of the public processor API</reason>
    </file>
    ...
    <file path="se.deversity.blindbean.processor.HomomorphicProcessor.isFloatingPoint(java.lang.String)">
      <reason>Pure internal type-dispatch helper — not part of the public processor API</reason>
    </file>
...
<rule>
  ...
  <ignored_elements>
    <file path="se.deversity.blindbean.async.BlindAsync.INIT_LOCK">
      <reason>Internal DCL synchronization monitor — not relevant to AI-assisted development workflows</reason>
    </file>
  </ignored_elements>
