...
- `se.deversity.blindbean.annotations.BlindEntity`: Public API surface. Preserve signature, Javadoc, backwards compatibility, and binary/source stability.
- `se.deversity.blindbean.annotations.BlindNested`: Public API surface. Preserve signature, Javadoc, backwards compatibility, and binary/source stability.
- `se.deversity.blindbean.annotations.Homomorphic`: Public API surface. Preserve signature, Javadoc, backwards compatibility, and binary/source stability.
- `se.deversity.blindbean.annotations.Scheme`: Public API surface. Preserve signature, Javadoc, backwards compatibility, and binary/source stability.
